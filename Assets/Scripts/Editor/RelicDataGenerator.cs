...
public class RelicDataGenerator
{
    ...
    private static readonly RelicRawData[] rawData = new RelicRawData[]
    {
        ...
        new RelicRawData { RelicID = "RustyGrapple", RelicNameEN = "Rusty Grapple", Rarity = RelicRarity.Common, FactionBonus = "+1 Random Stat", CoreEffect = "Grappling an enemy pulls you to them and briefly stuns them for 0.5s." },
        ...
        new RelicRawData { RelicID = "EmberFirefly", RelicNameEN = "Ember Firefly", Rarity = RelicRarity.Rare, FactionBonus = "+2 Random Stats", CoreEffect = "Plunge Attacks leave a burning trail on the ground for 3 seconds." },
        ...
        new RelicRawData { RelicID = "VialOfAshes", RelicNameEN = "Vial of Ashes", Rarity = RelicRarity.Rare, FactionBonus = "+2 Random Stats", CoreEffect = "Killing an enemy afflicted by an Echo (Burn/Poison) triggers an AoE explosion." },
